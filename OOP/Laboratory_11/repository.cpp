...
void RepositorySAVE::add_to_repository_container(Travel_Package* package) {
...
void RepositorySAVE::remove_from_repository_container(int id) {
...
void RepositorySAVE::update_package_from_repository_container(int id, const string& name, const string& destination, const string& type, double price) {
