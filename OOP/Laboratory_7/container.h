...
public :
    ...
    InteratorInventory<unknow_type> begin_ascendent() {
		return InteratorInventory<unknow_type>(*this, 0, false);
    }
	InteratorInventory<unknow_type> end_ascendent() {
		return InteratorInventory<unknow_type>(*this,size(),true);
	}

	InteratorInventory<unknow_type> begin_descendent() {
		return InteratorInventory<unknow_type>(*this,size()-1, true);
	}
	InteratorInventory<unknow_type> end_descendent() {
...
private:
	...
	Inventory<unknow_type>& inventory;
	int index;
	bool reverse;
...
public :
	...
	// constructor 
	InteratorInventory(Inventory<unknow_type>& inventory, int index,  bool reverse) : inventory(inventory), index(index), reverse(reverse) {}
